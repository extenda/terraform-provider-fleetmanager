...
func (o *ListStoresOK) Error() string {
	return fmt.Sprintf("[GET /fleet/tenant/{tenantId}/brand/{brandId}/country/{countryId}/store][%d] listStoresOK  %+v", 200, o.Payload)
}
...
func (o *ListStoresBadRequest) Error() string {
	return fmt.Sprintf("[GET /fleet/tenant/{tenantId}/brand/{brandId}/country/{countryId}/store][%d] listStoresBadRequest  %+v", 400, o.Payload)
}
